...
class ReportVentaO extends Component
{
    ...
    public function render()
    {
        ...
        'articulos.articulo', 'ventas.precioF','ventas.cantidad', 'articulos.presentacion','unidads.unidad','ventas.descuento')
        ->where('operacions.id',$op->id)->first();
        
        $emp=Empresa::first();
        
        return view('livewire.report-venta-o', compact('ventaOp','emp','datos'));



       // return view('livewire.report-venta-o');
    }
    public function generateReport()
    {
        ...
        $pdf=Pdf::loadView('livewire.report-venta-o', compact('ventaOp','emp','datos'));
        return $pdf->stream();
