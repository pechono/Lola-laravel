<x-app-layout>
    ...
    <div class="h-50% flex items-center justify-center mt-10">
        <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-xl sm:rounded-lg h-auto w-96 flex flex-col items-center justify-center border p-10">
            <a href="{{ route('comprobante') }}" target="_blank" class="mb-4 px-4 py-2 bg-blue-500 text-white rounded">Imprimir Comprobante</a> 
            <a href="{{ route('venta.index') }}"  class="px-4 py-2 bg-green-500 text-white rounded">Realizar Otra Operacion</a> 
        </div>
    </div>
